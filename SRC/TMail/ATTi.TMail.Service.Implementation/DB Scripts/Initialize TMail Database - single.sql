...
EXEC [dbo].[InstanceConfig_Create] 'dev', 1
EXEC [dbo].[EnvironmentAuthorization_Create] 'test'
EXEC [dbo].[EnvironmentAuthorization_Create] 'stage'
EXEC [dbo].[EnvironmentAuthorization_Create] 'live'
GO
