namespace ATTi.Core.Contracts
{
	...
	/// <summary>
	/// Static class containing invariant contract helper methods.
	/// </summary>
	public static class Invariant
	{
		

		const ContractType Contract = ContractType.Invariant;
		...
		public static void Enforce<T>(T target)
		{
			InvariantContractHelper<T>.InvokeContract(target);
		}
