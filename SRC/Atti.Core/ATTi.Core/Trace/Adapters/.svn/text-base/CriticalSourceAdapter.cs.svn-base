...
namespace ATTi.Core.Trace.Adapters
{
	...
	internal class CriticalSourceAdapter : ITraceSourceAdapter
	{
		...
		internal CriticalSourceAdapter(TraceSource source)
		{
		...
		internal CriticalSourceAdapter(string sourceName)
		{
