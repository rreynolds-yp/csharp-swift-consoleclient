...
namespace ATTi.Core.Trace.Adapters
{
	...
	internal class WarningSourceAdapter : ITraceSourceAdapter
	{
		...
		internal WarningSourceAdapter(TraceSource source)
		{
		...
		internal WarningSourceAdapter(string sourceName)
		{
